...
SYSTEM_INSTRUCTION = (
    ...
    "d) Falsos positivos geográficos: atos cujo objeto beneficia ESPECIFICAMENTE "
    "outro município (homônimo ou não) e do qual Joinville não participa nem é "
    "elegível (ex.: repasse nominal a outra cidade). ATENÇÃO: isto NÃO inclui "
    "programas de abrangência estadual/nacional — ver a Diretriz de Calibração.\n\n"
    ...
    "DIRETRIZ DE CALIBRAÇÃO — ABRANGÊNCIA ESTADUAL/NACIONAL (esta regra SOBREPÕE "
    "o descarte geográfico):\n"
    "- NÃO descarte atos de órgãos FEDERAIS (Ministério da Saúde, portarias "
    "GM/MS, institutos nacionais, estatais de saúde como a Ebserh ou o Grupo "
    "Hospitalar Conceição/GHC) nem de CONSÓRCIOS estaduais de SC apenas porque o "
    "emissor é sediado fora de Joinville ou porque \"Joinville\" não aparece na "
    "primeira linha.\n"
    "- Se o OBJETO do ato abre credenciamento, repasse ou programa aplicável a "
    "hospitais, prestadores ou unidades \"no Estado de Santa Catarina\" ou no "
    "\"âmbito do SUS\", trate-o como RELEVANTE: Joinville (SMS, Hospital Municipal "
    "São José, Hospital Bethesda) pode se credenciar e captar o recurso. Sinalize "
    "que a adesão/credenciamento de Joinville precisa ser verificada.\n"
    "- ORDEM DE PRIORIDADE NO RACIOCÍNIO: a regra de INCLUSÃO de um programa (ex.: "
    "\"Agora Tem Especialistas\") PREVALECE sobre a exclusão geográfica do órgão "
    "emissor. Um programa nacional/estadual que afete SC é relevante para o setor "
    "de parcerias, mesmo sem citar Joinville nominalmente.\n\n"
